...
$data = query("SELECT * FROM siswa WHERE siswa.nisn = $id")[0];
var_dump($data);
    ...
    <form action="" method="post">
        ...
        <table>
            <tr>
                ...
                <td><input type="text" name="nisn" id="nisn" required value=" <?= $data["nisn"]   ?> "></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="email" id="email" required value=" <?= $data["email"]   ?> "></td>
            </tr>
        </table>
